...
struct SessionState: Codable, Equatable {
  ...
  // Bundle id of the application the session runs inside (see HostApp.swift).
  // Optional so a file written before it existed still decodes, and nil for a
  // session whose ancestry named no application.
  var host: String?
  ...
  var isEmpty: Bool {
    terminal == nil && multiplexer == nil && host == nil && notified != true
  }
}
